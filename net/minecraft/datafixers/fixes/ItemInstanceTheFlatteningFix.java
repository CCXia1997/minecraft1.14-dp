...
public class ItemInstanceTheFlatteningFix extends DataFix
{
    ...
    public ItemInstanceTheFlatteningFix(final Schema schema, final boolean boolean2) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Dynamic<?> dynamic8;
        Typed<?> typed4;
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", (Type)type1, typed -> {
            ...
            if (!optional4.isPresent()) {
                ...
                integer7 = dynamic6.get("Damage").asInt(0);
                string8 = getItem((String)optional4.get().getSecond(), integer7);
                if (string8 != null) {
                    typed2 = typed2.set(opticFinder4, Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)string8));
                }
                if (ItemInstanceTheFlatteningFix.DAMAGABLE_ITEMS.contains(optional4.get().getSecond())) {
                    typed3 = typed.getOrCreateTyped(opticFinder5);
                    dynamic7 = typed3.get(DSL.remainderFinder());
                    dynamic8 = dynamic7.set("Damage", dynamic7.createInt(integer7));
                    typed2 = typed2.set(opticFinder5, typed3.set(DSL.remainderFinder(), dynamic8));
                }
                typed4 = typed2.set(DSL.remainderFinder(), dynamic6.remove("Damage"));
                return typed4;
            }
        });
    }
    ...
    @Nullable
    public static String getItem(@Nullable final String originalName, final int damage) {
        if (ItemInstanceTheFlatteningFix.ORIGINAL_ITEM_NAMES.contains(originalName)) {
            final String string3 = ItemInstanceTheFlatteningFix.FLATTENING_MAP.get(originalName + '.' + damage);
            return (string3 == null) ? ItemInstanceTheFlatteningFix.FLATTENING_MAP.get(originalName + ".0") : string3;
        }
        return null;
    }
    
    static {
        FLATTENING_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), hashMap -> {
