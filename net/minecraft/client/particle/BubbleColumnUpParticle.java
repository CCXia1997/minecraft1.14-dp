...
{
    private BubbleColumnUpParticle(final World world, final double x, final double y, final double z, final double double8, final double double10, final double double12) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType>
    {
        ...
        public Particle createParticle(final DefaultParticleType parameters, final World world, final double x, final double y, final double z, final double velocityX, final double velocityY, final double velocityZ) {
            final BubbleColumnUpParticle bubbleColumnUpParticle15 = new BubbleColumnUpParticle(world, x, y, z, velocityX, velocityY, velocityZ, null);
            bubbleColumnUpParticle15.setSprite(this.a);
            return bubbleColumnUpParticle15;
        }
    }
}
