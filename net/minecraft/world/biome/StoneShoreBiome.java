...
public final class StoneShoreBiome extends Biome
{
    public StoneShoreBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.STONE_CONFIG).precipitation(Precipitation.RAIN).category(Category.NONE).depth(0.1f).scale(0.8f).temperature(0.2f).downfall(0.3f).waterColor(4159204).waterFogColor(329011).parent(null));
