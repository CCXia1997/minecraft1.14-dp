...
public final class JungleEdgeBiome extends Biome
{
    public JungleEdgeBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.JUNGLE).depth(0.1f).scale(0.2f).temperature(0.95f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent(null));
