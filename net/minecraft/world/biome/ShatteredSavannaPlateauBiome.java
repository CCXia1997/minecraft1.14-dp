...
public final class ShatteredSavannaPlateauBiome extends Biome
{
    public ShatteredSavannaPlateauBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.NONE).category(Category.SAVANNA).depth(1.05f).scale(1.2125001f).temperature(1.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent("savanna_plateau"));
