...
public final class WoodedHillsBiome extends Biome
{
    public WoodedHillsBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.FOREST).depth(0.45f).scale(0.3f).temperature(0.7f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent(null));
        ...
        this.addSpawn(EntityCategory.b, new SpawnEntry(EntityType.WOLF, 5, 4, 4));
