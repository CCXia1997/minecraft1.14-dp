...
public final class FrozenRiverBiome extends Biome
{
    public FrozenRiverBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.SNOW).category(Category.RIVER).depth(-0.5f).scale(0.0f).temperature(0.0f).downfall(0.5f).waterColor(3750089).waterFogColor(329011).parent(null));
        ...
        this.addSpawn(EntityCategory.a, new SpawnEntry(EntityType.DROWNED, 1, 1, 1));
