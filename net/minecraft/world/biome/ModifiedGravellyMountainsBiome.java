...
public final class ModifiedGravellyMountainsBiome extends Biome
{
    protected ModifiedGravellyMountainsBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.GRAVELLY_MOUNTAIN, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.EXTREME_HILLS).depth(1.0f).scale(0.5f).temperature(0.2f).downfall(0.3f).waterColor(4159204).waterFogColor(329011).parent("wooded_mountains"));
