...
public final class SnowyTaigaHillsBiome extends Biome
{
    public SnowyTaigaHillsBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.SNOW).category(Category.TAIGA).depth(0.45f).scale(0.3f).temperature(-0.5f).downfall(0.4f).waterColor(4020182).waterFogColor(329011).parent(null));
