...
public class EndIslandsSmallBiome extends Biome
{
    public EndIslandsSmallBiome() {
        ...
        this.addFeature(GenerationStep.Feature.RAW_GENERATION, Biome.<DefaultFeatureConfig, NopeDecoratorConfig>configureFeature(Feature.az, FeatureConfig.DEFAULT, Decorator.J, DecoratorConfig.DEFAULT));
