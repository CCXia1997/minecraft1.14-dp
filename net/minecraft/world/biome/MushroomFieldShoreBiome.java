...
public final class MushroomFieldShoreBiome extends Biome
{
    public MushroomFieldShoreBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.MYCELIUM_CONFIG).precipitation(Precipitation.RAIN).category(Category.MUSHROOM).depth(0.0f).scale(0.025f).temperature(0.9f).downfall(1.0f).waterColor(4159204).waterFogColor(329011).parent(null));
