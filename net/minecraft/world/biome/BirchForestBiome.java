...
public final class BirchForestBiome extends Biome
{
    public BirchForestBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.FOREST).depth(0.1f).scale(0.2f).temperature(0.6f).downfall(0.6f).waterColor(4159204).waterFogColor(329011).parent(null));
