...
public final class GiantSpruceTaigaBiome extends Biome
{
    public GiantSpruceTaigaBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.TAIGA).depth(0.2f).scale(0.2f).temperature(0.25f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent("giant_tree_taiga"));
