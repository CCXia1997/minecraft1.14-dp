...
public final class ModifiedWoodedBadlandsPlateauBiome extends Biome
{
    public ModifiedWoodedBadlandsPlateauBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.WOODED_BADLANDS, SurfaceBuilder.BADLANDS_CONFIG).precipitation(Precipitation.NONE).category(Category.MESA).depth(0.45f).scale(0.3f).temperature(2.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent("wooded_badlands_plateau"));
