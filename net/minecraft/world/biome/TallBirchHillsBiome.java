...
public final class TallBirchHillsBiome extends Biome
{
    public TallBirchHillsBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.FOREST).depth(0.55f).scale(0.5f).temperature(0.6f).downfall(0.6f).waterColor(4159204).waterFogColor(329011).parent("birch_forest_hills"));
