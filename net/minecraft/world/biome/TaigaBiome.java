...
{
    public TaigaBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.TAIGA).depth(0.2f).scale(0.2f).temperature(0.25f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent(null));
        this.<VillageFeatureConfig>addStructureFeature(Feature.VILLAGE, new VillageFeatureConfig("village/taiga/town_centers", 6));
