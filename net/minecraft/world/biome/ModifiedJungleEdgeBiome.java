...
public final class ModifiedJungleEdgeBiome extends Biome
{
    public ModifiedJungleEdgeBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.JUNGLE).depth(0.2f).scale(0.4f).temperature(0.95f).downfall(0.8f).waterColor(4159204).waterFogColor(329011).parent("jungle_edge"));
