...
public final class SavannaPlateauBiome extends Biome
{
    protected SavannaPlateauBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.NONE).category(Category.SAVANNA).depth(1.5f).scale(0.025f).temperature(1.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011).parent(null));
        ...
        this.addSpawn(EntityCategory.b, new SpawnEntry(EntityType.LLAMA, 8, 4, 4));
