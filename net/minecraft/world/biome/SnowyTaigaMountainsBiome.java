...
public final class SnowyTaigaMountainsBiome extends Biome
{
    public SnowyTaigaMountainsBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.SNOW).category(Category.TAIGA).depth(0.3f).scale(0.4f).temperature(-0.5f).downfall(0.4f).waterColor(4020182).waterFogColor(329011).parent("snowy_taiga"));
