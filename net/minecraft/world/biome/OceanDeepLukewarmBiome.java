...
public class OceanDeepLukewarmBiome extends Biome
{
    public OceanDeepLukewarmBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_SAND_UNDERWATER_CONFIG).precipitation(Precipitation.RAIN).category(Category.OCEAN).depth(-1.8f).scale(0.1f).temperature(0.5f).downfall(0.5f).waterColor(4566514).waterFogColor(267827).parent(null));
        ...
        this.addSpawn(EntityCategory.d, new SpawnEntry(EntityType.SQUID, 8, 1, 4));
        this.addSpawn(EntityCategory.d, new SpawnEntry(EntityType.COD, 8, 3, 6));
