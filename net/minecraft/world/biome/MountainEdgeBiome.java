...
public final class MountainEdgeBiome extends Biome
{
    protected MountainEdgeBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG).precipitation(Precipitation.RAIN).category(Category.EXTREME_HILLS).depth(0.8f).scale(0.3f).temperature(0.2f).downfall(0.3f).waterColor(4159204).waterFogColor(329011).parent(null));
