...
public final class SnowyBeachBiome extends Biome
{
    public SnowyBeachBiome() {
        super(new Settings().<TernarySurfaceConfig>configureSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.SAND_CONFIG).precipitation(Precipitation.SNOW).category(Category.BEACH).depth(0.0f).scale(0.025f).temperature(0.05f).downfall(0.3f).waterColor(4020182).waterFogColor(329011).parent(null));
