...
public class IcebergFeatureConfig implements FeatureConfig
{
    ...
    public IcebergFeatureConfig(final BlockState state) {
        this.state = state;
    }
