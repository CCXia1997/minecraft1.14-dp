...
{
    protected BlastFurnaceBlock(final Settings settings) {
        super(settings);
    }
    ...
    protected void openContainer(final World world, final BlockPos pos, final PlayerEntity player) {
        ...
        if (blockEntity4 instanceof BlastFurnaceBlockEntity) {
            player.openContainer((NameableContainerProvider)blockEntity4);
            player.incrementStat(Stats.aq);
        }
    }
    ...
    public void randomDisplayTick(final BlockState state, final World world, final BlockPos pos, final Random rnd) {
        if (!state.<Boolean>get((Property<Boolean>)BlastFurnaceBlock.LIT)) {
            return;
        }
        ...
        if (rnd.nextDouble() < 0.1) {
            world.playSound(double5, double6, double7, SoundEvents.am, SoundCategory.e, 1.0f, 1.0f, false);
        }
        final Direction direction11 = state.<Direction>get((Property<Direction>)BlastFurnaceBlock.FACING);
        ...
        final double double11 = rnd.nextDouble() * 9.0 / 16.0;
